...
public class MonsterCreater : MonoBehaviour
{
    ...
    // 保留原有接口，内部调用统一方法
    public void OnCreateTortoise(int count) => CreateMonster(tortoise, count, "tortoise",10);
    public void OnCreateMushroom(int count) => CreateMonster(mushroom, count, "mushroom", 10);
    public void OnCreateFlyKoopa(int count) => CreateMonster(FlyKoopa, count, "FlyKoopa", 10);
